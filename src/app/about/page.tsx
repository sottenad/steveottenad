      ...
      <div className="max-w-screen-lg mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div className="md:col-span-1">
            <div className="aspect-square w-full max-w-xs rounded-xl bg-gray-200 dark:bg-gray-800 flex items-center justify-center text-gray-400 dark:text-gray-600 text-6xl font-medium">
            ...
            <div className="mt-8 flex flex-col gap-4">
              <Link 
                ...
                className="inline-flex items-center gap-3 text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400"
              >
          ...
          <div className="md:col-span-2">
            ...
            <div className="prose prose-gray dark:prose-invert">
              ...
              <h3 className="text-xl font-semibold mt-12 mb-4">Skills & Expertise</h3>
