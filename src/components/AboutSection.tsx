    ...
    <section className="py-12 md:py-16 bg-muted">
      <div className="max-w-screen-lg mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row items-start gap-8">
          <FadeIn direction="left" duration={0.7} delay={0.1} className="w-full md:w-1/3">
            <HoverMotion scale={1.05} rotate={5} duration={0.4}>
          ...
          <FadeIn direction="right" duration={0.7} delay={0.2} className="w-full md:w-2/3">
